export const plan = [{
     ...
     },
     {
         ...
         service:[
            ...
            {id:5,text:"Designing the UX & UI"},
            {id:6,text:"Graphic Design"},
            {id:7,text:"Web Development(Main Website & CMS and Admin Panel Included)"},
            {id:8,text:"Mobile Development - iOS & Android"},
            ...
            {id:12,text:"Medium QA(Quality Assurance of Shipped Features with basic testing)"},
     ...
     {
         title: "PaceSetter",
         about: "This comprehensive package is tailored to fulfill the demands of established businesses and large enterprises.",
         price: "4999",
         buttonType: "solid",
         strike: "",
         color:false,
         service:[
            {id:1,text:"Product Conceptualization"},
            {id:2,text:"1 - 1 Support(Highest Priority Support - within 2 - 3 hours)"},
            {id:3,text:"Weekly Strategy Calls"},
            {id:4,text:"Dedicated Project Manager"},
            {id:5,text:"Designing the User Experience(UX) and User Interface(UI)"},
            {id:6,text:"Graphic Designing"},
            {id:7,text:"Web Development(Main Website & CMS included)"},
            {id:8,text:"Mobile Development - iOS & Android"},
            {id:9,text:"Covers almost any type of API Integrations"},
            {id:10,text:"Testing suite on codebase"},
            {id:11,text:"Advanced QA(Quality Assurance of Shipped Features with end - to - end QA of entire app)"},
            {id:12,text:"Proper Technical Documentation of Product Usage"},
            {id:13,text:"Continuous Integration / Continuous Delivery pipeline"},
            {id:14,text:"Deployment(depends on the requirements)"},
            {id:15,text:"Technical Documentation of Endpoints"},
            {id:16,text:"Scalability"},
            {id:17,text:"Monitoring and Maintenance"},
            {id:18,text:"Maintenance(depends on the requirements)"},
            {id:19,text:"Content writing"},
            {id:20,text:"Copywriting"},
            {id:21,text:"SEO"},
            {id:22,text:"Financial Consulting on Business Model(through our trusted business partners at get FPA)"}
